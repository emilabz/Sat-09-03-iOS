...
{
    @IBOutlet weak var tblvCountryList: UITableView!
    ...
    //var countryimgList=[UIImage]()
    override func viewDidLoad() {
        super.viewDidLoad()
        self.tblvCountryList.delegate=self
        self.tblvCountryList.dataSource=self
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        print(self.countryList[indexPath.row])
    }
